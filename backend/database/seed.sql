-- ============================================================================
-- JOB RECRUITMENT MANAGEMENT SYSTEM (JRMS) - SEED DATA
-- Default Test Passwords for all seeded users: "Password@123"
-- bcrypt hash: $2a$10$r.d3f5FzQ/W2G3n4J5K6Le1M2N3O4P5Q6R7S8T9U0V1W2X3Y4Z5a6 (Password@123)
-- ============================================================================
...
(2, 6, 'San Jose, CA', 'Full Stack Developer proficient in React, Node.js, Express, and MySQL databases.', 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=300', '/uploads/resumes/priya_sharma_resume.pdf', 'priya_sharma_resume.pdf'),
...
(2, 'Full Stack Engineer', 'WebFlow Systems', 'San Jose, CA', '2021-08-01', NULL, TRUE, 'Built Node.js microservices and React dashboards with MySQL transaction management.'),
...
(2, 'Backend & Cloud', 'dns', 'Node.js, Python, Java, MySQL, Cloud Infrastructure & Microservices'),
...
(1, 1, 1, 'Senior Flutter Architect', 'We are looking for an expert Flutter Developer to lead cross-platform mobile development for our flag-ship recruitment SaaS product.', 'Architect scalable Flutter applications with Provider/Riverpod state management; Integrate HTTP REST APIs; Implement customMaterial 3 design systems.', '3+ years of professional Flutter experience; Strong knowledge of Dart, REST APIs, and SQLite/SecureStorage.', 'Flutter, Dart, Provider, REST API, Git', 3, 95000.00, 130000.00, 'Full Time', 'Remote', 'San Francisco, CA', 2, '2026-11-30', 'active'),
(2, 1, 2, 'Node.js & MySQL Backend Engineer', 'Seeking a skilled backend developer to build robust Express.js REST APIs and optimize database queries for high concurrency.', 'Design normalized MySQL database tables; Create secure JWT auth middleware; Build RESTful endpoints.', '2+ years Node.js and Express experience; Strong SQL proficiency with MySQL/PostgreSQL.', 'Node.js, Express.js, MySQL, REST API, JWT', 2, 85000.00, 115000.00, 'Full Time', 'Hybrid', 'San Francisco, CA', 3, '2026-12-15', 'active'),
(3, 2, 2, 'Cloud DevOps & Systems Architect', 'Manage cloud infrastructure, CI/CD pipelines, Docker containers, and Kubernetes clusters.', 'Maintain 99.9% system uptime; Automate cloud deployments; Enforce database backup and security protocols.', 'Experience with AWS/GCP, Docker, Kubernetes, Linux system administration.', 'Docker, AWS, Kubernetes, Linux, MySQL', 4, 110000.00, 150000.00, 'Full Time', 'Remote', 'Austin, TX', 1, '2026-10-31', 'active'),
...
(1, 1, 1, 'Interview Scheduled', 'I have over 4 years of hands-on Flutter experience and would love to bring my expertise to InnovateTech.', '2026-09-01 10:30:00'),
(2, 2, 2, 'Shortlisted', 'My solid foundation in Express.js and MySQL database normalization makes me an ideal fit for this role.', '2026-09-02 14:15:00'),
(3, 4, 3, 'Under Review', 'As a product designer passionate about clean visual systems, I am excited about Designify Studio.', '2026-09-03 09:45:00'),
(4, 5, 1, 'Applied', 'Interested in exploring additional team collaboration opportunities with CloudScale.', '2026-09-04 16:20:00');

-- 11. SAVED_JOBS
INSERT INTO saved_jobs (seeker_id, job_id, saved_at) VALUES
(1, 2, '2026-09-01 11:00:00'),
(1, 4, '2026-09-02 12:30:00'),
(2, 1, '2026-09-03 15:10:00');
