...
class RegisterRecruiterScreen extends StatefulWidget {

  const RegisterRecruiterScreen({super.key});

  @override
  State<RegisterRecruiterScreen> createState() => _RegisterRecruiterScreenState();
}

class _RegisterRecruiterScreenState extends State<RegisterRecruiterScreen> {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Post jobs, review candidates & schedule interviews',
